          ...
          <div className='grid grid-cols-12 md:gap-x-8 gap-y-6'>
            ...
            <div className='col-span-12 md:col-span-12 lg:col-span-6 order-1 md:order-2'>
              <AnimatedContent
                ...
                threshold={0.2}
              >
                <img draggable="false" className='w-full h-auto aspect-[16/12] object-cover object-center rounded-2xl shadow-lg' src="./images/about-banner.webp" alt="Meet Michael Walker" />
              </AnimatedContent>
            </div>
          </div>
        </div>
