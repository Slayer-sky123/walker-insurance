        ...
        <nav className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
            <div className="lg:container mx-auto px-4 md:px-10 lg:px-14 py-2 flex justify-between items-center">
                ...
                <div className='hidden lg:flex'>
                    <Link draggable="false" to='/contact' className='text-sm lg:text-base inline-flex items-center gap-x-2 text-white font-medium text-center bg-[var(--primary__color)] hover:scale-95 rounded-md py-3 px-6 transition-all duration-150 ease-linear'>
