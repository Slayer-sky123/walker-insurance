            ...
            <div className='lg:container mx-auto'>
                <div className='flex justify-center mb-20 lg:mb-32'>
                    <div className='md:w-[65%] lg:w-1/2'>
                        <h4 className='text-center text-white font-semibold text-3xl lg:text-4xl'>Ready to Secure Your Financial Future?</h4>
                        <p className='text-white/80 text-center mt-4 lg:mt-5'>Let's have a conversation about how we can help protect your income and preserve your legacy for generations to come.</p>
                ...
                <div className='grid grid-cols-12 gap-y-10 mb-10'>
                    <div className='col-span-12 md:col-span-4 lg:col-span-4'>
                        <h5 className='font-semibold text-white text-xl lg:text-xl'>Walker Insurance</h5>
                        <p className='text-white/90 text-base mt-4'>Protecting Your Income.<br></br>Preserving Your Legacy.</p>
                    </div>
                    <div className='col-span-12 md:col-span-4 lg:col-span-4'>
                        <h5 className='font-semibold text-white text-xl lg:text-xl'>Contact</h5>
                        <ul className='mt-4 flex flex-col gap-y-2'>
                            <li>
                                <a draggable="false" href="mailto:info@walkerinsurance.ca" className='inline-flex items-center gap-x-2 text-white'>
                    ...
                    <div className='col-span-12 md:col-span-4 lg:col-span-4'>
                        <h5 className='font-semibold text-white text-xl lg:text-xl'>Office Hours</h5>
                        <ul className='mt-4 flex flex-col gap-y-2'>
                            <li>
                ...
                <p className='text-center text-gray-300 te'>© 2025 Walker Insurance & Estate Planning Ltd. All rights reserved.</p>
            </div>
        </div>
    )
}
