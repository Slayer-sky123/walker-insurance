            ...
            <div className='lg:container mx-auto'>
                ...
                <div className='grid grid-cols-12 md:gap-x-10 gap-y-10 mb-10'>
                    <div className='col-span-12 md:col-span-4 lg:col-span-5'>
                        ...
                        <p className='text-white/90 text-base mt-4'>Walker Insurance is licensed in the province of Manitoba. Licensing in other provinces is currently in progress.</p>
                    </div>
